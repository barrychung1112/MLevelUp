...
type Props = LoadableViewProps & { profile: ProfilePreferencesView | null; goals: readonly GoalOptionView[]; onSave: (profile: ProfilePreferencesView) => void; onReset: () => void; isSubmitting?: boolean; submitError?: string; successMessage?: string };
...
function SettingsForm({ profile, goals, onSave, onReset, isSubmitting, submitError, successMessage }: Omit<Props, "profile" | "status" | "errorMessage"> & { profile: ProfilePreferencesView }) {
