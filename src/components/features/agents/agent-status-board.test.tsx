...
describe("AgentStatusBoard", () => {
  test("labels Ready, AI, and fallback agent states from data", () => {
    render(
      <AgentStatusBoard
        agents={[
          ...
          { id: "collector", name: "Resource Collector", status: "idle", lastRun: "02:10", summary: "Phase 4", provenance: "Ready" },
        ]}
      />,
    );
